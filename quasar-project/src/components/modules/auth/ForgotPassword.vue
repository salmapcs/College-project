    ...
    <q-form class="flex flex-center" style="width: 600px; height: 500px;">
      <div class="q-gutter-sm" style="width: 600px; height: 300px;">
        ...
        <div class="row" style="display: flex; justify-content: center;">
            <div style="text-align: center;">Please provide the email address that you used when you signed up for your account.</div>
        <div >  
        ...
        <br>
        <div class="row" style="display: flex; justify-content: center;">
        <q-btn @click="resetPassword" style="width: 300px; height: 30px; text-align: center;" class="btn-fixed-width flex flex-center" color="green-6" label="Reset Password"  />
        </div>
  
        <div class="row" style="display: flex; justify-content: center;">
          <div style="margin-right: 10px;">New here? </div>
          <div class="text-green-6">Sign Up</div>
        </div>

        <div class="row" style="display: flex; justify-content: center;">
          <div style="margin-right: 10px;">Already have an account? </div>
          <div class="text-green-6">Login.</div>
        </div>
      </div>
    </q-form>
  </template>
